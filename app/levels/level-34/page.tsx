...
const questions: Question[] =[
  { id: 1, titles:'Hidden Animal',questionName:'I’m a striped predator, king of the jungle in Asia.', image: '/levels/level-34/img1.png', correct: 'TIGER'},
    { id: 2,titles:'Hidden Country', questionName:'Known for the Taj Mahal, spices, and Bollywood.', image: '/levels/level-34/img2.png', correct: 'INDIA'},
    { id: 3,titles:'Hidden Object', questionName:'Everyone carries me, I ring, text, and scroll.', image: '/levels/level-34/img3.png', correct: 'PHONE'},
    { id: 4,titles:'Hidden Fruit', questionName:' Sweet tropical fruit, king of summer.', image: '/levels/level-34/img4.png', correct: 'MANGO' },
    { id: 5,titles:'Hidden Game Keyword', questionName:'Programmers use me to unlock solutions — I’m also a secret in this game.', image: '/levels/level-34/img5.png', correct: 'CODE'},

]


export default function Level34Page() {
...
//    const newChar = prev.length === 0 ? key.key.toUpperCase() : key.key.toLowerCase();
        return prev + key.key.toUpperCase();
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-600">Loading Level 34...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50 flex items-center justify-center p-4">
        <Card className="max-w-4xl mx-auto">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-3xl font-bold text-green-700">Level 34 Complete!</CardTitle>
            <div className="mt-2">
