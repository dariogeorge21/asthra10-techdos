...
const questions: Question[] =[
  { id: 1, question: '/levels/level-35/img1.jpeg', correct: 'Switzerland', options: ["Russia", "Sweden", "Switzerland", "Chile"] },
    { id: 2, question: '/levels/level-35/img2.jpeg', correct: "Nepal",
    options: ["Uruguay", "Nepal", "Laos", "Syria"]},
    { id: 3, question: '/levels/level-35/img3.jpeg', correct: "Saudi Arabia",
    options: ["Singapore", "Saudi Arabia", "Morocco", "Ivory coast"] },
    { id: 4, question: '/levels/level-35/img4.jpeg',  correct: "Sweden",
    options: ["Sweden", "Chile", "Jamaica", "Norway"] },

      // New ones
  { id: 5, question: '/levels/level-35/img5.jpeg',  correct: "Argentina",  
  options: ["Luxembourg", "Kenya", "Belize", "Argentina"]  },
  { id: 6, question: '/levels/level-35/img6.jpeg', correct: "Chile",  
  options: ["Costa Rica", "Cuba", "Czech Republic", "Chile"] },
  { id: 7, question: '/levels/level-35/img7.jpeg',  correct: "Sri Lanka",  
  options: ["Iran", "Honduras", "Ivory Coast", "Sri Lanka"] },
  { id: 8, question: '/levels/level-35/img8.jpeg', correct: "Australia",  
  options: ["South Africa", "Australia", "United Kingdom", "Canada"]  },
...
export default function Level35Page() {
  ...
  // Flash effect component (defined before any returns that use it)
  const FlashEffect = () => {
      ...
      return (
        <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-lg text-gray-600">Loading Level 35...</p>
          </div>
        </div>
      );
    }
        ...
        <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50 flex items-center justify-center p-4">
          <Card className="max-w-4xl mx-auto">
            <CardHeader className="text-center">
              ...
              <CardTitle className="text-3xl font-bold text-green-700">Level 35 Complete!</CardTitle>
              <div className="mt-2">
